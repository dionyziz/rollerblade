...
\begin{theorem}[Bitcoin Timeliness]
  ...
  % TODO(dionyziz): See if we can make this bound tighter to $k + \ell + 3$
...
\begin{proof}
  ...
  \[
     ...
     |\chain^P_{r_1}| - |\chain^{P^*}_{r^*}| + k \leq % TODO(dionyziz): Check for off-by-one errors
     2k + \ell + 1\,. % TODO(dionyziz): Check for off-by-one errors
  \]
