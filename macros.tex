...
\newcommand{\LCView}{\textsc{View}^{\textsf{DPCP}}}
\newcommand{\PEView}{\textsc{View}^{\textsf{PS}}}

\newcommand{\LCExtern}{\textsc{Extern}^{\textsf{DPCP}}}
\newcommand{\PEExtern}{\textsc{Extern}^{\textsf{PS}}}

\newcommand{\LCExec}{\textsc{Exec}^{\textsf{DPCP}}}
\newcommand{\PEExec}{\textsc{Exec}^{\textsf{PS}}}