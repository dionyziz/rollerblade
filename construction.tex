...
ledger protocols,
$\Y[j][1], \allowbreak \Y[j][2], \ldots,\allowbreak \Y[j][i],\allowbreak \ldots,\allowbreak \Y[j][n]$.
...
the emulated machine $\Z[j][i]$ has concluded its execution of rounds $1, \ldots, \allowbreak \emulationRound$.
