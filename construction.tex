...
The \emulateMachine function takes the \sid, the overlay protocol $\Pi$ to run,
...
to ``settle'' before he can invoke \emulateMachine with the respective \simulationRound.
...
Lastly, the \emulateMachine function invokes the \lread function of the simulated
