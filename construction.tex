...
overlay protocol $\Pi$, the underlying index $i$, the ledger $\Ledger[j][i]$, all the underlying ledger protocol instances,
...
$\inboxes[r]$ and $\writeboxes[r]$ to be empty lists. The entries $\inboxes[0]$ and $\writeboxes[0]$ will remain empty
