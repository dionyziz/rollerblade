...
\begin{proof}[Sketch]
  ...
  Let $i$ be an arbitrary party in $H$ and $r$ be an arbitrary round $1 \leq r \leq R - \Delta_v - 1$.
  ...
  We will prove that $V^*_{i,r} = V'_{i,r}$ for $r \geq 0$ by induction on $r$.
  Let $r$ be arbitrary.
  ...
  and Eq~\ref{conj:simulation:ind-hyp} also holds.

  In either case, we wish to show that $c^*(r + \Delta_v + 1, r, r) = c'(r)$.
