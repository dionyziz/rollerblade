...
\begin{restatable}[Rollerblade Cross-party]{lemma}{restateLemCrossParty}\label{lem:cross-party}
...
\begin{restatable}[Rollerblade Consistency]{lemma}{restateLemConsistency}\label{lem:consistency}
...
%       from the original)
\begin{restatable}[Rollerblade Simulation]{conjecture}{restateConjSim}\label{conj:simulation}
