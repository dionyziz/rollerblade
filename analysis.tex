...
\begin{conjecture}[Rollerblade Cross-party]\label{conj:cross-party}
...
\begin{proof}[Sketch]
  ...
  Because $\Ledger[][i]$ is \emph{good}, $\Ledger[j][i][r]$ and $\Ledger[j'][i][r]$
  ...
  in $\Ledger[j'][i][r'][|\Ledger[j'][i][r]|{:}]$ with recorded round $r^* < r - v_i < r' - v_i$.\qed
