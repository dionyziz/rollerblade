...
instance running within $\Lambda[j]$ is a Bitcoin client, whereas the
...
\begin{proof}[Sketch]
  ...
  \emph{in vitro}, where $\simulationRound = R - \Delta_v - 1$
  ...
  Induction step: By inductive hypothesis $V^*_{i,r - 1} = V'_{i,r - 1}$.

  \noindent
  \textbf{Subclaim 1a:} $\LLambda[j].\emulateMachine(i, r)$ ``extends''
  $\LLambda[j].\emulateMachine(i, r - 1)$.
