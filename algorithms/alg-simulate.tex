\begin{algorithm}[H]
  ...
  \begin{algorithmic}[1]
    \Function{\sf simulate}{$\Pi, i, \Ledger[j][i], \Y[j], \simulationRound, \realityRound$}
      \Let{(\writes, \inboxes)}{\prepareSimulationInputs(\Pi, i, \Ledger[j][i], \Y[j], \simulationRound, \realityRound)}
