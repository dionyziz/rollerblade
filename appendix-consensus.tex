...
\begin{theorem}[Security]
  ...
  Consider an execution of $\recursiveConsensus_{\Pi}(\mathcal{Y})$ in which $n-f$ of the $n$ underlying
...
\end{theorem}
\begin{proof}[Sketch]
  Let $\mathcal{E}$ be the execution of $\recursiveConsensus_{\Pi}$. By assumption, $n-f$ of
