...
\begin{definition}[Honest View in the Emulated Setting]
  ...
  \[
  \begin{bmatrix}
    \emulationSnapshot(H_1, 1) & \ldots & \emulationSnapshot(H_1, R - \Delta_v - 1)\\
                     \vdots & \ddots & \vdots \\
    \emulationSnapshot(H_{|H|}, 1) & \ldots & \emulationSnapshot(H_{|H|}, R - \Delta_v - 1)
  \end{bmatrix}\,,
  \]
  where $\emulationSnapshot(H_i, r)$ denotes the return value of invoking,
